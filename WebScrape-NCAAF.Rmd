...
state_plot_one <- ggplot(state_map, mapping = aes(x = long, y = lat), group = group) +
  ...
  geom_point(data = geo_plot_one, aes(x=lon, y=lat, size = tot_signed, color = commit_rating)) +
...
state_plot_two <- ggplot(state_map, mapping = aes(x = long, y = lat), group = group) +
  coord_fixed(1.3) +
  geom_polygon(color = "black", fill = "gray") +
  geom_point(data = geo_plot_two, aes(x=lon, y=lat, size = tot_signed, color = commit_rating)) +
